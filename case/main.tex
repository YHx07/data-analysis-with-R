...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{getmode }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(x) \{}
\NormalTok{ a }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{(x)}
 \FunctionTok{as.numeric}\NormalTok{(}\FunctionTok{names}\NormalTok{(a)[a }\SpecialCharTok{==} \FunctionTok{max}\NormalTok{(a)])}
\NormalTok{\}}
...
\FunctionTok{getmode}\NormalTok{(first\_purchase}\SpecialCharTok{$}\NormalTok{time\_to\_purchase)}
\end{Highlighting}
\end{Shaded}
